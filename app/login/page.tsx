...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-[#020617] flex items-center justify-center p-4 overflow-hidden relative">
            {/* Background Effects */}
            <div className="absolute top-[-20%] left-[-10%] w-[600px] h-[600px] bg-purple-600/20 rounded-full blur-[128px] pointer-events-none" />
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="text-center mb-8 space-y-2">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-600 to-blue-600 shadow-[0_0_40px_-10px_rgba(124,58,237,0.5)] mb-4">
                        <Fingerprint className="text-white w-8 h-8" />
                    </div>
                    <h1 className="text-3xl font-bold text-white tracking-tight">
                        Z-Gate <span className="text-purple-500">Security</span>
                    </h1>
                ...
                <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-2xl p-8 shadow-2xl">
                    <form onSubmit={handleLogin} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                <Input
                                    ...
                                    className="bg-slate-950/50 border-slate-700 pl-10 text-slate-200 focus:border-purple-500/50 transition-all h-11"
                        ...
                        <Button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-white font-semibold h-11 shadow-lg shadow-purple-900/20 transition-all active:scale-[0.98]"
                        >
                            {loading ? (
